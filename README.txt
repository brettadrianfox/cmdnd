...
Guide to the files:
    ...
    cmdnd_logic directory:
        This is the backend logic for the program
        ...
        These files exist to switch between custom Spotify playlists in the terminal. Will eventually be integrated into the Cmdnd GUI.
            ...
            is used if you want to copy another user's playlists in bulk. THIS IS A TEMPORARY, THROWAWAY FILE NOT TO BE USED IN THE FINAL IMPLEMENTATION.
    ...
    cmdnd_implementation directory:
        These are the main files that integrate the various processes and produce the overall Cmdnd system, displayed onto a web page
